      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            {subValue && <div className="text-slate-400 text-sm">{subValue}</div>}
          </div>
        </div>
...
const FinancialDashboard: React.FC = () => {
  ...
  const previousData = previousMonth ? dashboardData[previousMonth as keyof typeof dashboardData] : null;
  ...
  const metrics = [
    ...
    },
    {
      ...
      subValue:
        currentData.cash_flow_stability_score >= 70
          ...
          ? 'Good'
          : 'Fair',
      change: calculateChange(currentData.cash_flow_stability_score, previousData?.cash_flow_stability_score ?? null),
      period: 'Since last month',
    ...
    },
    {
      ...
      subValue: 'Monthly',
      change: calculateChange(currentData.net_monthly_cash_flow, previousData?.net_monthly_cash_flow ?? null),
      period: 'Since last month',
    ...
    },
    {
      ...
      subValue:
        currentData.credit_score >= 75
          ...
          ? 'Good'
          : 'Fair',
      change: calculateChange(currentData.credit_score, previousData?.credit_score ?? null),
      period: 'Since last month',
