      ...
      <div className="w-full max-w-md bg-slate-800 rounded-lg shadow-2xl p-8 sm:p-10 relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <h1 className="text-3xl font-bold text-white">FINEDGE AI</h1>
          </div>
          ...
          {!isLogin && (
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 bg-slate-700 cursor-pointer border-slate-600 rounded"
              />
        ...
        <div className="mt-8 text-center text-xs text-slate-500">
          2025 © FinEdge - By{" "}
          <a className="text-slate-400 hover:text-white underline">FinEdge</a>
        </div>
      </div>
    </div>
  );
